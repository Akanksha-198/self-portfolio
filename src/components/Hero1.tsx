...
//       {/* <div className="absolute inset-0 bg-gradient-to-r from-blue-800 to-black-900 opacity-10 animate-[pulse_8s_ease-in-out_infinite]"></div> */}
...
//           From intuitive front-end designs to scalable back-end systems, I craft
//           seamless user experiences with creativity and precision. Let’s build
//           something{" "}
//           <span className="font-semibold text-yellow-400">extraordinary</span>{" "}
//           together.
//         </p>
...
export default function Hero1() {
  const { currentText: firstPart, isFinished: firstPartFinished } = useTypewriter("Hii, I am ", 100);
  const { currentText: secondPart } = useTypewriter(firstPartFinished ? "AAkanksha" : "", 100);
