...
//     description:
//       "Skilled in solving complex DSA problems to create efficient, scalable, and optimized solutions.",
//     icon: <FaLaptopCode className="text-blue-500 text-6xl" />,
//   },
//   {
//     title: "MERN Stack Development",
//     description:
//       "Expert in building scalable full-stack web applications using MongoDB, Express.js, React, and Node.js.",
...
//           Technologies
//         </h2>
//         <div className="flex w-20 h-20 sm:grid-cols-3 md:grid-cols-4 gap-12 mb-20 items-center">
//           {Technologies.map((item, index) => (
//             <div
//               key={index}
//               className="flex flex-col  justify-center  p-6 rounded-lg border-2 border-gray-500 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-gray-900/40 items-center"
//             >
//               <div >{item.icon}</div>
...
//         <h2 className="text-5xl font-extrabold text-yellow-500 mb-16 text-center">
//           My Specialization
//         </h2>
//         <div className="grid grid-rows-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
//           {specializations.map((item, index) => (
//             <div
//               key={index}
//               className="flex flex-col items-center text-center space-y-6 p-10 rounded-xl bg-gray-800 transition-all duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-pink-500/20"
//             >
//               <div className="p-6 rounded-full bg-gray-700">{item.icon}</div>
